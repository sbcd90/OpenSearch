...
public class CorrelationParamsContextTests extends OpenSearchTestCase {
    ...
    public void testStreams() throws IOException {
        ...
        Assert.assertEquals(context, copy);
    }
    ...
    public void testEquals() {
        ...
        CorrelationParamsContext context1 = new CorrelationParamsContext(VectorSimilarityFunction.EUCLIDEAN, parameters);
        CorrelationParamsContext context2 = new CorrelationParamsContext(VectorSimilarityFunction.EUCLIDEAN, parameters);
