...
public class CorrelationVectorsEngineIT extends OpenSearchRestTestCase {
    ...
    private static final String SECURITY_ANALYTICS_VECTOR_TYPE = "correlation_vector";
    ...
    private static final Float[][] TEST_VECTORS = new Float[][]{{ 1.0f, 1.0f, 1.0f, 1.0f }, { 2.0f, 2.0f, 2.0f, 2.0f }, { 3.0f, 3.0f, 3.0f, 3.0f }};
    private static final float[][] TEST_QUERY_VECTORS = new float[][]{ { 1.0f, 1.0f, 1.0f, 1.0f }, { 2.0f, 2.0f, 2.0f, 2.0f }, { 3.0f, 3.0f, 3.0f, 3.0f } };
    ...
    private Response makeRequest(RestClient client, String method, String endpoint, Map<String, String> params,
